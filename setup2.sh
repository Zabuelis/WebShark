...
echo -e "\e[1mIf you are running this on a remote server, close the connection and use the following command to create an SSH tunnel to access the application locally:\e[0m"
